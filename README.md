...
## 📅 Day 1
* 🎲 Dice Problem
* Revised Java basics and started solving logic-building problems.
...
* Practiced digit extraction using `%` (modulus) and `/` (division) operators.
...
* Learned how to reverse an integer using loops and arithmetic operations.
...
* Implemented prime number checking using loop-based divisibility logic.
...
* Developed logic to determine whether a number is a power of another number.
...
* Calculated factorial using iterative loops and strengthened understanding of multiplication-based algorithms.
...
Inverted Right Triangle Pattern
Implemented a Java program to print an **Inverted Right Triangle** star (`*`) pattern based on the number of rows entered by the user. Practiced nested `for` loops, user input handling, method creation, and pattern printing logic in Java.
...
### Diamond Pattern
Diamond Pattern
Today I Practised  by combining a Full Pyramid and an Inverted Pyramid. The upper half increases the number of stars row by row, while the lower half decreases them, creating a diamond shape. It demonstrates the use of nested loops, spacing logic, and pattern printing concepts in Java.
...
Number Triangle Pattern
Strengthened my Java fundamentals by implementing the Number Triangle Pattern, reinforcing nested loops, iteration, and pattern-building logic.
...
## 📅 Day 28 – Floyd's Triangle Pattern

Today's Java practice focused on printing the **Floyd's Triangle** pattern using nested loops. This program demonstrates how the outer loop controls the number of rows, while the inner loop prints consecutive numbers. A variable is incremented after each print to generate the sequence, making it an excellent exercise for understanding nested loops, pattern printing, and sequential number generation in Java.
...
## 📅 Day 41 - Zig-Zag Pattern in Java
