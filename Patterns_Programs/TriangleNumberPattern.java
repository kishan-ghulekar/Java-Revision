...
/*
Number Triangle Explanation:
1.The outer loop (i) controls the rows and runs from 1 to rows.
...
5.After printing a number, num is incremented using num++ to print the next consecutive number.
